...
def generate_launch_description():
    return LaunchDescription([
        ...
        # Robot simulator node (optional)
        # Node(
        #     package='learning_tf2_cpp',
        #     executable='robots_sim',
        ...
        # RViz2 node (optional) - simple launch without config
        Node(
            package='rviz2',
            executable='rviz2',
            name='rviz2',
...
# T/G: Move forward/backward (X)
# F/H: Move left/right (Y)
# R/Y: Move up/down (Z)
# V/B: Rotate pitch up/down